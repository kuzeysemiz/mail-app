export const TURKEY_LOCATIONS: Record<string, string[]> = {
  ...
  "Antalya": [
    "Aksu","Alanya","Demre","Döşemealtı","Elmalı","Finike","Gazipaşa","Gündoğmuş",
  ...
  "Eskişehir": [
    ...
    "Mihallıçcık","Odunpazarı","Sarıcakaya","Seyitgazi","Sivrihisar","Tepebaşı",
  ],
  "Trabzon": [
  ...
  "Sakarya": [
    ...
    "Karasu","Kaynarca","Kocaali","Mithatpaşa","Pamukova","Sapanca","Serdivan",
    "Söğütlü","Taraklı",
  ],
  "Kocaeli": [
  ...
  "Samsun": [
    "Alaçam","Asarcık","Atakum","Ayvacık","Bafra","Canik","Çarşamba","İlkadım",
    "Kavak","Ladik","Salıpazarı","Tekkeköy","Terme","Vezirköprü","Yakakent",
  ],
};

export const CITY_NAMES = Object.keys(TURKEY_LOCATIONS).sort();
